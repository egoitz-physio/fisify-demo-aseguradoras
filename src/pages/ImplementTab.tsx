...
const roadmap = [
  {
    ...
    actions: [
      ...
      'Alinear a la aseguradora y a sus canales en el plan de activación.',
...
export default function ImplementTab({ isDark: _isDark, clientName = 'Aseguradora' }: ImplementTabProps) {
  return (
      ...
      <section className="grid lg:grid-cols-2 gap-6 mb-20">
        <motion.div {...fadeUp} transition={{ delay: 0.05 }} className="rounded-[2rem] border border-white/8 bg-[linear-gradient(180deg,rgba(13,26,46,0.92),rgba(10,21,36,0.82))] p-7 lg:p-8">
          ...
          <div className="space-y-4">
            {[
              'Account Manager para la aseguradora y sus canales con conocimiento profundo del negocio y los asegurados.',
